...
| **_cover_**       | Thumbnail of the post. Will be the OG image of the post. Useful for social media sharing and SEO. | default = SITE.ogImage or generated SVG image |
...
![This is an example of an OG image generated automatically if cover frontmatter is not provided](/adding-posts-in-astro-lane.png)
_This is an example of an OG image generated automatically if cover frontmatter is not provided._
